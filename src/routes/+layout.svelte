...
{#if dev}
  <div class="bg-gradient-to-r from-amber-400 via-yellow-400 to-orange-400 text-amber-950 text-center font-black text-xs py-1 px-4 border-b-2 border-amber-500 shadow-xs flex items-center justify-center gap-2 tracking-wider uppercase select-none sticky top-0 z-[99999]">
